 ...
 * @author hp
 */
public class gold_history extends javax.swing.JFrame {
    ...
    public void DBconnect(){
        ...
        try {
            ...
            str=con.prepareStatement ("SELECT * FROM `perchases`");
    ...
    public void TBLclick(){
        ...
        String date = table.getModel().getValueAt(row, 14).toString();
        ...
        float Chandi= Float.parseFloat(table.getModel().getValueAt(row, 7).toString());
        float Nag= Float.parseFloat(   table.getModel().getValueAt(row, 8).toString() );
        float Safi= Float.parseFloat(  table.getModel().getValueAt(row, 9).toString() );
        float Karat= Float.parseFloat( table.getModel().getValueAt(row, 10).toString() );
        float Kaat=Float.parseFloat(   table.getModel().getValueAt(row, 11).toString() );
        float Pasa= Float.parseFloat(  table.getModel().getValueAt(row, 12).toString() );
        float Rkam= Float.parseFloat(  table.getModel().getValueAt(row, 13).toString() );
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NAME", "PHONE", "CNIC", "RATE", "P/GRAM RATE", "WAZAN", "C-DANDI", "NAG", "SAFI WAZAN", "KARAT", "KAAT", "PASA", "RAKAM", "DATE"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if (p==0){
                String Str="DELETE FROM `perchases` WHERE ID= '" + id + "'";
    ...
    private void idKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_idKeyReleased
        ...
        try{
            ...
            if(field.equals("ID")){
                str=con.prepareStatement ("SELECT * FROM `perchases` where ID="+id.getText()+"");
            }else{
                str=con.prepareStatement ("SELECT * FROM `perchases` where "+field+" LIKE '%"+id.getText()+"%'");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gold_history.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gold_history().setVisible(true);
            }
        });
    }
